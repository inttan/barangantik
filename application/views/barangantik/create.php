<div class="card">
  <div class="card-header">Tambah Barang Antik</div>
  <div class="card-body">
    <form method="post" action="<?= site_url('barangantik/store'); ?>">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="number" step="0.01" name="nilai_estimasi" class="form-control" required>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select name="pemilik_id" class="form-control" required>
          <?php foreach($pemilik as $p): ?>
            <option value="<?= $p['id_pemilik']; ?>"><?= htmlspecialchars($p['nama_pemilik']); ?></option>
          <?php endforeach; ?>
        </select>
      </div>
